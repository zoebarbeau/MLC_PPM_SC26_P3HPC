...
class ProblemManager
{
  public:
    ...
    using particle_members =
        Cabana::MemberTypes<double[3], double[3], double[3],double>;
    ...
    ProblemManager( const ExecutionSpace& exec_space,
                    ...
                    const int particles_per_cell, const double amp)
        : _mesh( mesh )
        , _amp( amp )
...
*/
    ...
    {
        _node_gather_halo->gather( execution_space(), *_velocity, *_vorticity, *_vortx );
    }
